...
# to simulate the imposed motion of a kite.
...
"""
    main(; p1=[0,0,0], p2=nothing, fix_p1=true, fix_p2=false, acc_p2=[0,0,0])

Build and simulate the tether. If `fix_p2` is true, `acc_p2` is prescribed as the
acceleration of the second end point, which simulates the imposed motion of a kite.
"""
...
# the second end point is fixed and pulled downwards with 1 m/s², as a kite would

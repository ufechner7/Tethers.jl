# constant alpha + spline used for lift
using Timers
tic()
...
@with_kw mutable struct Settings @deftype Float64
    ...
    v_wind_tether::Vector{Float64} = [0.0, 20, 0.0]      # wind velocity [m/s]
    ...
    KITEPOS0::Matrix{Float64} =                         # KITE points         ##MAKE A FUNCTiON FOR IT
    [0.000         chord_length/2          -chord_length/2                0                      0;
    0.000               0                        0                    kite_width/2          -kite_width/2;
    0.000     kite_height+bridle_height  kite_height+bridle_height   bridle_height          bridle_height]    
    # spring constants
